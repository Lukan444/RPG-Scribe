...
- Name: Tooltip Quality Assurance - Accessibility Basics >> should have proper color contrast
- Location: D:\AI Projects\RPG-Archivist-Web2\tests\tooltip-basic-qa.spec.ts:253:7
...
Call log:
  - navigating to "/", waiting until "load"
    ...
    at D:\AI Projects\RPG-Archivist-Web2\tests\tooltip-basic-qa.spec.ts:254:16
```
