...
- Name: Tooltip Quality Assurance - Accessibility Basics >> should support keyboard navigation
- Location: D:\AI Projects\RPG-Archivist-Web2\tests\tooltip-basic-qa.spec.ts:231:7
...
Call log:
  - navigating to "/", waiting until "load"
    ...
    at D:\AI Projects\RPG-Archivist-Web2\tests\tooltip-basic-qa.spec.ts:232:16
```
