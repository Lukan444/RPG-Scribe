...
- Name: Tooltip Quality Assurance - Cross-Browser Compatibility >> should handle touch interactions on mobile browsers
- Location: D:\AI Projects\RPG-Archivist-Web2\tests\tooltip-basic-qa.spec.ts:137:7
...
Call log:
  - navigating to "/", waiting until "load"
    ...
    at D:\AI Projects\RPG-Archivist-Web2\tests\tooltip-basic-qa.spec.ts:139:16
```
