...
- Name: Tooltip Quality Assurance - Performance Validation >> should handle memory usage efficiently
- Location: D:\AI Projects\RPG-Archivist-Web2\tests\tooltip-basic-qa.spec.ts:181:7
...
Call log:
  - navigating to "/", waiting until "load"
    ...
    at D:\AI Projects\RPG-Archivist-Web2\tests\tooltip-basic-qa.spec.ts:182:16
```
