...
- Name: Tooltip Quality Assurance - Performance Validation >> should meet basic performance requirements
- Location: D:\AI Projects\RPG-Archivist-Web2\tests\tooltip-basic-qa.spec.ts:159:7
...
Call log:
  - navigating to "/", waiting until "load"
    ...
    at D:\AI Projects\RPG-Archivist-Web2\tests\tooltip-basic-qa.spec.ts:161:16
```
