...
export interface TimelineEntry {
  ...
  associatedEntityId: string;  // ID of the associated entity (renamed from entityId)
  associatedEntityType: string; // Type of the associated entity
  entryType: TimelineEntryType; // Type of timeline entry
  position: TimelinePosition;   // Position in timeline
  dualTimestamp: DualTimestamp; // Dual timestamp data
  title: string;               // Display title
  description?: string;        // Optional description
  summary?: string;            // Brief summary (from models)
  outcome?: string;            // Result or outcome (from models)
  duration?: TimeGap;          // Duration of this entry
  participants?: string[];     // IDs of participating entities
  locationId?: string;         // Location where this occurred
  sessionId?: string;          // Session this entry belongs to (from models)
  storyArcId?: string;         // Story arc this entry is part of (from models)
  tags?: string[];            // Descriptive tags
  isSecret?: boolean;         // Whether this is GM-only information
  importance?: number;         // Importance level (1-10) (from models)
  isAutoGenerated?: boolean;   // Whether this was auto-generated (from models)
  lastValidated?: Date;        // When this entry was last validated (from models)
  validationStatus?: 'valid' | 'warning' | 'error'; // Current validation status (from models)
